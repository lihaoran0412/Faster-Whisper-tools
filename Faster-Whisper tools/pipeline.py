...
def main():
    ...
    for seg in segments_raw:
        ...
        pct = 15 + int(min(seg.start / total_dur * 40, 40))
    ...
    if args.format == "srt":
        output_path = os.path.join(out_dir, base_name + ".srt")
        ...
        output_path = os.path.join(out_dir, base_name + "_转写.txt")
        with open(output_path, "w", encoding="utf-8") as f:
