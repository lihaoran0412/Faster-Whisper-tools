...
py -3.12 -c "import subprocess; subprocess.run(['nvidia-smi'], capture_output=True)" >nul 2>&1
if errorlevel 1 (
    ...
    echo        You can continue, but transcription will be very slow.
)
...
echo [1/7] PyTorch CUDA 12.1...
py -3.12 -m pip install torch==2.5.1 torchaudio==2.5.1 --index-url https://download.pytorch.org/whl/cu121
